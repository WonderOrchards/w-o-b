...
- Added `scripts/generate_index.py`.
...
- Added a GitHub Actions workflow that generates `_index.json` automatically during deployment.
- The generated index is included in the GitHub Pages deployment without creating automated commits to `main`.
- GitHub Pages publishes the resulting repository state.
