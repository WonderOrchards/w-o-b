yaml
title: Development Thread Header
version: alpha-v2.1
status: active
tags: [development, template, instructions, refined]
last_updated: 2025-09-04
🌳 Wonder Orchards — Database Development Thread Header (v2.1)
...
📝 Plan
Check /data/database-growth.md for inspiration.
Ensure alignment with /dna.md and /vision.md.
⚙️ Execute
Apply requested changes to the appropriate files.
Follow formatting + metadata standards.
...
📤 Output
Important — AI Confirmation Required:
...
Regenerate _index.json via scripts/generate_index.py.
